...
const _rawDummyApplications: Application[] = [
  ...
  // Case 11: 복수필지 — 심의위원회 검토 완료 (필지별 기각/보상/기각 혼합)
  {
    ...
    landDataList: [
      ...
      { currentUsage: "대" as const, landSubType: "residential-detached" as const, actualUsage: "대" as const, reportedShape: "가로장방형" as const, farmMachineDifficulty: false, accessRoadLost: false, waterChannelLost: false },
      { currentUsage: "대" as const, landSubType: "residential-detached" as const, actualUsage: "대" as const, reportedShape: "사다리형" as const, farmMachineDifficulty: false, accessRoadLost: false, waterChannelLost: false },
    ],
  ...
  // Case 18: 복수필지 — 심의위원회 기각 혼합 (일부 중토위, 일부 도로공사, 일부 미선택)
  {
    ...
    landDataList: [
      ...
      { currentUsage: "전" as const, landSubType: "" as const, actualUsage: "전" as const, reportedShape: "사다리형" as const, farmMachineDifficulty: true, accessRoadLost: false, waterChannelLost: false },
      { currentUsage: "대" as const, landSubType: "residential-detached" as const, actualUsage: "대" as const, reportedShape: "삼각형" as const, farmMachineDifficulty: false, accessRoadLost: false, waterChannelLost: false },
    ],
  ...
  // Case 19: 복수필지 — 심의위원회 전필지 기각 (중토위 2건, 도로공사 1건)
  {
    ...
    landDataList: [
      ...
      { currentUsage: "답" as const, landSubType: "" as const, actualUsage: "답" as const, reportedShape: "역삼각형" as const, farmMachineDifficulty: true, accessRoadLost: false, waterChannelLost: false },
      { currentUsage: "답" as const, landSubType: "" as const, actualUsage: "답" as const, reportedShape: "부정형" as const, farmMachineDifficulty: false, accessRoadLost: false, waterChannelLost: true },
    ],
