        ...
        <div className="p-4">
          ...
          >
            <div className="flex flex-col">
              <div className="mb-3">
                <h4 className="text-[16px] font-bold text-gray-700">담당자 검토</h4>
              </div>
              <div className="grid grid-cols-3 gap-5">
                <div className={cn(
                  ...
                  <p className={cn("text-[16px] font-medium", finalJudgment === "수용가능" ? JUDGMENT_COLORS.수용가능.text : "text-gray-500")}>수용가능 판단</p>
                </div>
                <div className={cn(
                  "border rounded p-3 text-center transition-all",
                  finalJudgment === "수용불가" ? `${JUDGMENT_COLORS.수용불가.border} ${JUDGMENT_COLORS.수용불가.bgLight}` : "border-gray-200 bg-gray-50"
                )}>
                  <p className={cn("text-[16px] font-medium", finalJudgment === "수용불가" ? JUDGMENT_COLORS.수용불가.text : "text-gray-500")}>수용불가 판단</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-col">
              <div className="mb-3">
                <h4 className="text-[16px] font-bold text-gray-700">최종 결정</h4>
              </div>
              <div className="grid grid-cols-2 gap-5">
                <motion.div 
                  animate={{ scale: finalJudgment === "수용가능" && animationStep >= 7 ? 1.02 : 1 }}
                  className={cn(
                    "rounded p-3 text-center text-[16px] font-semibold border transition-all",
                    finalJudgment === "수용가능" 
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[16px] text-gray-400">/ 기준 {effectiveThreshold}㎡ {isRatioRelaxed && "(완화)"}</span>
              </div>
              <div className="flex items-center gap-2">
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        <span className={cn("text-[16px] font-bold", titleColor)}>
          {type} 경로
        </span>
      </div>
        ...
        >
          {c.title === null ? (
            <div className={cn(
              ...
              <p className="text-[16px] text-gray-400 italic text-center">해당 없음</p>
            </div>
          ) : (
            <div className={cn(
              ...
              <div className="space-y-1.5 pl-6">
                {c.items.map((item, itemIdx) => (
                  <div 
                    key={itemIdx}
                    className={cn(
                      "flex items-start gap-2 text-[16px] py-1 px-2 rounded",
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.subLabel && (
                        <p className="text-[16px] text-gray-400 mt-0.5">{item.subLabel}</p>
                      )}
                      {/* 충족/미충족 상세 설명 — 민원인 값은 굵게, 기준값은 흐리게 */}
                      {isActive && item.isSelected && item.isMet && item.explanationMet && (
                        <p className={`text-[16px] ${JUDGMENT_COLORS.충족.text} mt-1`}>
                      ...
                      {isActive && item.isSelected && !item.isMet && item.explanationUnmet && (
                        <p className={`text-[16px] ${JUDGMENT_COLORS.미충족.text} mt-1`}>
              ...
              {/* 참고 사항 */}
              {c.note && (
                <p className="text-[16px] text-gray-400 mt-1.5">{c.note}</p>
              )}
            </div>
          )}
        </motion.div>
      ...
      {isActive && conditionStatus && (
        <motion.div
          ...
          className="text-[16px] space-y-0.5 mb-3 py-2 border-t border-gray-100"
        >
          <p className={cn(
      ...
      {isActive && conditionStatus && (
        ...
        >
          <span className={cn(
            "px-4 py-1.5 rounded-full text-[16px] font-bold text-white",
