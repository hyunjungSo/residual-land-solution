  ...
  return (
    <div className="flex h-screen w-screen">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-white leading-snug">
              AI 잔여지 손실 보상 판독 시스템<br />관리자
            </h1>
            <div className="h-1 w-24 rounded-full bg-[#2E8B57]" />
          </div>
          <p className="text-[16px] text-white/50">&copy; 2026 Korea Expressway Corporation. All rights reserved.</p>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col items-center justify-center bg-white px-8 lg:w-1/2">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div className="space-y-1.5">
              <label htmlFor="login-id" className="text-[16px] font-medium text-gray-700">아이디</label>
            ...
            {/* 비밀번호 */}
            <div className="space-y-1.5">
              <label htmlFor="login-pw" className="text-[16px] font-medium text-gray-700">비밀번호</label>
              <div className="relative">
            ...
            {/* 에러 메시지 */}
            {error && <p className="text-[16px] text-red-500 text-center">{error}</p>}
        ...
        <p className="mt-8 text-center text-[16px] text-gray-400 lg:hidden">&copy; 2026 한국도로공사</p>
      </div>
    </div>
  );
}
